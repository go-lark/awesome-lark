...
- [go-lark/lark(★186)](https://github.com/go-lark/lark): An easy-to-use SDK for Feishu and Lark Open Platform (Instant Messaging API only)
...
- [larksuite/oapi-sdk-java(★193)](https://github.com/larksuite/oapi-sdk-java): Larksuite official Java SDK

#### JavaScript

- [larksuite/node-sdk(★120)](https://github.com/larksuite/node-sdk): larksuite open sdk for nodejs
