...
- [go-lark/lark(★240)](https://github.com/go-lark/lark): An easy-to-use SDK for Feishu and Lark Open Platform (Instant Messaging API only)
- [chyroc/lark(★464)](https://github.com/chyroc/lark): Feishu(飞书)/Lark Open API Go SDK, Support ALL Open API and Event Callback.
- [larksuite/oapi-sdk-go(★547)](https://github.com/larksuite/oapi-sdk-go): larksuite oapi sdk by golang
...
- [larksuite/node-sdk(★236)](https://github.com/larksuite/node-sdk): larksuite open sdk for nodejs
...
- [larksuite/oapi-sdk-python(★474)](https://github.com/larksuite/oapi-sdk-python): Larksuite development interface SDK
