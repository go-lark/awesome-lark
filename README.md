...
- [chyroc/lark(★294)](https://github.com/chyroc/lark): Feishu(飞书)/Lark Open API Go SDK, Support ALL Open API and Event Callback.
...
- [larksuite/node-sdk(★37)](https://github.com/larksuite/node-sdk): larksuite open sdk for nodejs
