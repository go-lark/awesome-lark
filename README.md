...
- [go-lark/lark(★236)](https://github.com/go-lark/lark): An easy-to-use SDK for Feishu and Lark Open Platform (Instant Messaging API only)
...
- [larksuite/oapi-sdk-java(★289)](https://github.com/larksuite/oapi-sdk-java): Larksuite official Java SDK
