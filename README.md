...
- [chyroc/lark(★342)](https://github.com/chyroc/lark): Feishu(飞书)/Lark Open API Go SDK, Support ALL Open API and Event Callback.
...
- [larksuite/node-sdk(★88)](https://github.com/larksuite/node-sdk): larksuite open sdk for nodejs
...
- [larksuite/oapi-sdk-python(★128)](https://github.com/larksuite/oapi-sdk-python): Larksuite development interface SDK
