...
- [chyroc/lark(★314)](https://github.com/chyroc/lark): Feishu(飞书)/Lark Open API Go SDK, Support ALL Open API and Event Callback.
- [larksuite/oapi-sdk-go(★223)](https://github.com/larksuite/oapi-sdk-go): larksuite oapi sdk by golang
...
- [larksuite/oapi-sdk-java(★115)](https://github.com/larksuite/oapi-sdk-java): Larksuite official Java SDK
