...
- [chyroc/lark(★394)](https://github.com/chyroc/lark): Feishu(飞书)/Lark Open API Go SDK, Support ALL Open API and Event Callback.
- [larksuite/oapi-sdk-go(★384)](https://github.com/larksuite/oapi-sdk-go): larksuite oapi sdk by golang
...
- [larksuite/oapi-sdk-java(★204)](https://github.com/larksuite/oapi-sdk-java): Larksuite official Java SDK
...
- [larksuite/oapi-sdk-python(★265)](https://github.com/larksuite/oapi-sdk-python): Larksuite development interface SDK
