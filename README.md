...
- [go-lark/lark(★179)](https://github.com/go-lark/lark): An easy-to-use SDK for Feishu and Lark Open Platform (Instant Messaging API only)
- [chyroc/lark(★375)](https://github.com/chyroc/lark): Feishu(飞书)/Lark Open API Go SDK, Support ALL Open API and Event Callback.
- [larksuite/oapi-sdk-go(★359)](https://github.com/larksuite/oapi-sdk-go): larksuite oapi sdk by golang
...
- [larksuite/oapi-sdk-java(★183)](https://github.com/larksuite/oapi-sdk-java): Larksuite official Java SDK

#### JavaScript

- [larksuite/node-sdk(★114)](https://github.com/larksuite/node-sdk): larksuite open sdk for nodejs
...
- [larksuite/oapi-sdk-python(★232)](https://github.com/larksuite/oapi-sdk-python): Larksuite development interface SDK
