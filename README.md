...
- [go-lark/lark(★149)](https://github.com/go-lark/lark): An easy-to-use SDK for Feishu and Lark Open Platform (Messaging API only)
- [chyroc/lark(★329)](https://github.com/chyroc/lark): Feishu(飞书)/Lark Open API Go SDK, Support ALL Open API and Event Callback.
...
- [larksuite/oapi-sdk-java(★129)](https://github.com/larksuite/oapi-sdk-java): Larksuite official Java SDK
