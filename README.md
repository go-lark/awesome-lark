...
- [chyroc/lark(★283)](https://github.com/chyroc/lark): Feishu(飞书)/Lark Open API Go SDK, Support ALL Open API and Event Callback.
- [larksuite/oapi-sdk-go(★162)](https://github.com/larksuite/oapi-sdk-go): larksuite oapi sdk by golang
- [fastwego/feishu(★150)](https://github.com/fastwego/feishu): [飞书] A fast feishu development sdk written in Golang
...
- [larksuite/oapi-sdk-java(★93)](https://github.com/larksuite/oapi-sdk-java): Larksuite official Java SDK
