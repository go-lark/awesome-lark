...
- [chyroc/lark(★289)](https://github.com/chyroc/lark): Feishu(飞书)/Lark Open API Go SDK, Support ALL Open API and Event Callback.
...
- [larksuite/oapi-sdk-java(★98)](https://github.com/larksuite/oapi-sdk-java): Larksuite official Java SDK
